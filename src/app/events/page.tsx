            ...
            >
              {upcomingEvents.length === 0 ? (
                ...
                upcomingEvents.map((event, i) => (
                  <div key={event.id} className="bg-white rounded-3xl p-6 md:p-8 flex flex-col md:flex-row gap-8 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          {tab === "past" && (
            ...
            >
              {pastEvents.map((event) => (
                <div key={event.id} className="bg-white rounded-[2rem] overflow-hidden border border-gray-100 shadow-sm group">
