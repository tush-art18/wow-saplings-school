        ...
        <div className="mb-16 grid grid-cols-2 md:grid-cols-4 gap-6 text-center border-b border-gray-100 pb-16">
          {[
            ...
            <div key={i} className="relative">
              <div className="w-16 h-16 mx-auto bg-gray-50 border border-gray-200 rounded-2xl flex items-center justify-center text-3xl mb-4 shadow-sm">
                {item.icon}
              </div>
              ...
              {success ? (
                ...
                >
                  ...
                  <div className="flex gap-4 pt-6 border-t border-gray-100">
                    ...
                    <button 
                      type="submit" 
                      className="flex-1 bg-primary text-white font-bold py-4 rounded-xl shadow-lg hover:bg-primary-dark transition-all hover:-translate-y-1 flex items-center justify-center gap-2"
                    >
